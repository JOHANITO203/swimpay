...
data class PremiumLocalizedCopy(
    ...
    companion object {
        ...
        private val fr = PremiumLocalizedCopy(
            ...
            welcomeBody = "Choisissez comment ouvrir votre espace marchand sur ce telephone.",
            createAccount = "Creer un compte",
            signIn = "Se connecter",
            chooseProfileTitle = "Choisissez votre profil",
            sameRights = "Meme acces dans l'app, quel que soit le profil choisi.",
            personalProfile = "Profil personnel",
            personalProfileBody = "Pour demarrer simplement avec un compte marchand leger.",
            commerceProfile = "Profil commerce",
            commerceProfileBody = "Pour nommer une activite ou une boutique sans changer les droits.",
            recoverTitle = "Retrouver un compte",
            recoverBody = "Choisissez un moyen de recuperation pour une session deja creee.",
            googleRecovery = "Continuer avec Google",
            googleRecoveryBody = "Recuperer un compte deja lie pour la connexion.",
            terminalTitle = "Terminal Marchand",
            paymentsGroup = "PAIEMENTS",
            banks = "Banques",
            receivingMethods = "Moyens de reception",
            confirmationMode = "Mode de confirmation",
            businessGroup = "BUSINESS",
            developerIntegration = "Integration developpeur",
            sales = "Ventes",
            ...
            appearanceBody = "Appliquez le mode systeme, clair ou sombre.",
            choose = "Choisir",
            active = "Actif"
        )
