...
data class PremiumLocalizedCopy(
    ...
    companion object {
        ...
        private val translations = listOf(
            ...
            LocalizedText("En cours", "In progress", "В процессе"),
            LocalizedText("Montant à vérifier", "Amount to review", "Сумма к проверке"),
            LocalizedText("NOTIFICATION CAPTÉE", "CAPTURED NOTIFICATION", "ПОЛУЧЕННОЕ УВЕДОМЛЕНИЕ"),
            LocalizedText("SIGNAUX DE PROVENANCE", "PROVENANCE SIGNALS", "СИГНАЛЫ ПРОИСХОЖДЕНИЯ"),
            LocalizedText("Application source", "Source app", "Приложение-источник"),
            LocalizedText("Canal de notification", "Notification channel", "Канал уведомления"),
            LocalizedText("Montant exact", "Exact amount", "Точная сумма"),
            LocalizedText("Expéditeur", "Sender", "Отправитель"),
            LocalizedText("Référence", "Reference", "Ссылка"),
            LocalizedText("Rapprochement commande", "Order match", "Сопоставление заказа"),
            LocalizedText("Reconnu", "Recognized", "Распознано"),
            LocalizedText("Confiance", "Confidence", "Уверенность"),
            LocalizedText("Décision manuelle marchand", "Manual merchant decision", "Ручное решение продавца"),
