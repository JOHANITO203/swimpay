        ...
        >
          <div className="flex flex-col items-center gap-8 md:flex-row">
            <div className="w-full flex-1">
              <h3 className="mb-2 flex items-center gap-3 font-display text-2xl font-bold text-white">APK Merchant v1.2.4</h3>
              <p className="mb-6 text-sm text-slate-500">Version stable • Format APK direct</p>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-slate-500">Scanner pour mobile</p>
            </div>
          </div>
