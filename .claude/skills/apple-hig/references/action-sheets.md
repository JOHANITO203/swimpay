...
When you use SwiftUI, you can offer action sheet functionality in all platforms by specifying a  for a confirmation dialog. If you use UIKit, you use the  to display an action sheet in iOS, iPadOS, and tvOS.
