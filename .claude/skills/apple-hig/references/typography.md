...
You can use the constants defined in  to access all system fonts — don’t embed system fonts in your app or game. For example, use  to get the system font on all platforms; use  to get the New York font.
