...
In iOS, iPadOS, and visionOS, widgets support Dynamic Type sizes from Large to AX5 when you use  to choose a system font or  to choose a custom font. For more information about Dynamic Type sizes, see .
