...
describe('android receiver contracts', () => {
  ...
  it.each([
    ...
    ['raw card number', { cardNumber: '2202201234567890' }, AndroidReceiverErrorCodes.RAW_PHONE_REJECTED],
    ['raw card PAN', { cardPan: '2202201234567890' }, AndroidReceiverErrorCodes.RAW_PHONE_REJECTED],
    ['raw full card', { full_card: '2202201234567890' }, AndroidReceiverErrorCodes.RAW_PHONE_REJECTED],
    ['credential sms_code', { sms_code: '111111' }, AndroidReceiverErrorCodes.PAYLOAD_INVALID],
    ['credential pin', { pin: '0000' }, AndroidReceiverErrorCodes.PAYLOAD_INVALID],
